...
class Memory:
    ...
    def __init__(self, memory_size, num_state, num_action, num_agent):
        '''
        ...
        '''
        self.sumtree = SumTree(memory_size, num_state + (num_agent + 1) * 3 * 2 + 1 * num_agent \
                               + num_state * num_agent + 1 + 1)  # instantiate a SumTree
