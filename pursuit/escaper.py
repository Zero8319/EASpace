...
def escaper(agent_position, target_position, target_orientation, obstacle_total, num_agent, zigzag_count, zigzag_last,
            last_e, slip_flag):
    '''
    This function is used to calculate the evader's displacement.
    ...
    Input:
        ...
        target_orientation: the heading of evader
        obstacle_total: the positions of all obstacles
        num_agent: the number of pursuers
        zigzag_count: how many timesteps zigzagging lasts before this timestep
        zigzag_last: the zigzagging orientation at the last timestep
        last_e: the slip orientation at the last timestep
        slip_flag: whether the evader is slipping through two pursuers at the last timestep
    Output:
        F_total: the displacement of evader
        zigzag_count: how many timesteps zigzagging lasts at this timestep
        zigzag_last: the zigzagging orientation at the this timestep
        zigzag_flag: the zigzagging orientation at the this timestep
        wall_following: whether the evader is moving according to wall following rules
        slip_flag: whether the evader is slipping through two pursuers at this timestep
        distance_from_nearest_obstacle: the distance from the nearest obstacle
        last_e: the slip orientation at this timestep
    '''
    ...
    if distance_from_nearest_agent > 3000:
        F_total = F_total / 5
